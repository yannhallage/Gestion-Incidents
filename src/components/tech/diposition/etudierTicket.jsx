                ...
                <div className="">
                    <div className="">
                        <span className="text-2xl">
                            ...
                            <span>
                                Ticket : {extendedChatss[donnee].id}
                            </span>
                        </span>
                        <br /> <br />
                        <span className="font-bold">
                            ...
                            <div className='flex space-x-2'>
                                ...
                                <span className=''>
                                    Reference ticket : {extendedChatss[donnee].name} <br />
                    ...
                    {/* mot de l'equipe */}
                    <div className="mt-11  border p-2 rounded-md border-[#ccc] bg-[#F7F7F7]">
                        <span className=''>
                            {/* description du ticket attribuer au technicien qui va suivre 
                                intervenir sur la panne 
                             */}
                           {extendedChatss[donnee].message}
                        </span>
                    </div>
                    {/*  */}
                    <div className=' grid grid-cols-2'>
                        <div className="mt-5 text-[15px] space-y-3 ">
                            <div className='font-sans'>
                                date de creation ticket : {extendedChatss[donnee].creationticket} <br />
                                Statut : {extendedChatss[donnee].statut} <br />
                                Priorité : {extendedChatss[donnee].Priorité} <br />
                                {/* type : {extendedChatss[donnee].message} <br /> */}
                            ...
                            <div className='space-x-2 text-[14px] '>
                                ...
                                <ButtonClassic
                                    ...
                                    event={() => setModifierTicket(!modifierTicket)}
                                />
                                <ButtonClassic
                        ...
                        <div className='mt-6'>
                            ...
                            {
                                modifierTicket && <SelectComponent />
                            }
                            {
                                conclus && <SecondSelect />
                            }
