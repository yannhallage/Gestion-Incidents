...
const DashboardLayoutTech = () => {
  ...
  const HandlclickTicketAttribuer = () => {
    setValeur(<TicketAttribuer />);
          ...
          <div style={containerStyle}>
            ...
            <div style={menuStyle}>
              ...
              <div
                ...
                onClick={HandlclickTicketAttribuer}
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
...
export default DashboardLayoutTech;